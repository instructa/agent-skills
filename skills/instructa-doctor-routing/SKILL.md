---
name: instructa-doctor-routing
description: Route doctor failures to the right owner: base/core install, required plan.ledger provider, optional capability provider, or project plugin.
---
...
Route doctor failures to the right owner: base/core install, required plan.ledger provider, optional capability provider, or project plugin.
...
```txt
Skill: instructa-doctor-routing
Kit layer:
Project plugin:
Spec package:
Ledger:
