---
name: project-plugin-selector
description: Select and explain the project plugin that should depend on instructa.base for the current project type.
---
...
Select and explain the project plugin that should depend on instructa.base for the current project type.
