---
name: plandb-setup
description: Prepare the required plan.ledger path for the kit flow and document the fallback ledger when the provider is unavailable.
---
...
Prepare the required plan.ledger path for the kit flow and document the fallback ledger when the provider is unavailable.
